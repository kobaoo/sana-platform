...
import (
	"context"
	ent2 "encore.app/orgstructure/organizations/ent"
	"fmt"
)

// The OrganizationFunc type is an adapter to allow the use of ordinary
// function as Organization mutator.
type OrganizationFunc func(context.Context, *ent2.OrganizationMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f OrganizationFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	if mv, ok := m.(*ent2.OrganizationMutation); ok {
		return f(ctx, mv)
	}
