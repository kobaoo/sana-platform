...
import (
	"context"
	"database/sql/driver"
	organization2 "encore.app/orgstructure/organizations/ent/organization"
...
type OrganizationQuery struct {
	config
	ctx          *QueryContext
	order        []organization2.OrderOption
	inters       []Interceptor
...
func (_q *OrganizationQuery) Order(o ...organization2.OrderOption) *OrganizationQuery {
...
func (_q *OrganizationQuery) QueryParent() *OrganizationQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(organization2.Table, organization2.FieldID, selector),
			sqlgraph.To(organization2.Table, organization2.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, organization2.ParentTable, organization2.ParentColumn),
		)
...
func (_q *OrganizationQuery) QueryChildren() *OrganizationQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(organization2.Table, organization2.FieldID, selector),
			sqlgraph.To(organization2.Table, organization2.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, organization2.ChildrenTable, organization2.ChildrenColumn),
		)
		fromU = sqlgraph.SetNeighbors(_q.driver.Dialect(), step)
		return fromU, nil
	}
...
func (_q *OrganizationQuery) First(ctx context.Context) (*Organization, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{organization2.Label}
	}
	return nodes[0], nil
}
...
func (_q *OrganizationQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	...
	if len(ids) == 0 {
		err = &NotFoundError{organization2.Label}
		return
	}
	return ids[0], nil
}
...
func (_q *OrganizationQuery) Only(ctx context.Context) (*Organization, error) {
	...
	case 0:
		return nil, &NotFoundError{organization2.Label}
	default:
		return nil, &NotSingularError{organization2.Label}
	}
}
...
func (_q *OrganizationQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	...
	case 0:
		err = &NotFoundError{organization2.Label}
	default:
		err = &NotSingularError{organization2.Label}
	}
	return
}
...
func (_q *OrganizationQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	if err = _q.Select(organization2.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *OrganizationQuery) Clone() *OrganizationQuery {
	...
	return &OrganizationQuery{
		config:       _q.config,
		ctx:          _q.ctx.Clone(),
		order:        append([]organization2.OrderOption{}, _q.order...),
...
func (_q *OrganizationQuery) GroupBy(field string, fields ...string) *OrganizationGroupBy {
	...
	grbuild.label = organization2.Label
...
func (_q *OrganizationQuery) Select(fields ...string) *OrganizationSelect {
	...
	sbuild.label = organization2.Label
...
func (_q *OrganizationQuery) prepareQuery(ctx context.Context) error {
	...
	for _, f := range _q.ctx.Fields {
		if !organization2.ValidColumn(f) {
...
func (_q *OrganizationQuery) loadParent(ctx context.Context, query *OrganizationQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *Organization)) error {
	...
	query.Where(organization2.IDIn(ids...))
...
func (_q *OrganizationQuery) loadChildren(ctx context.Context, query *OrganizationQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *Organization)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(organization2.FieldParentID)
	}
	query.Where(predicate.Organization(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(organization2.ChildrenColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *OrganizationQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(organization2.Table, organization2.Columns, sqlgraph.NewFieldSpec(organization2.FieldID, field.TypeUUID))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, organization2.FieldID)
		for i := range fields {
			if fields[i] != organization2.FieldID {
				_spec.Node.Columns = append(_spec.Node.Columns, fields[i])
			}
		}
		if _q.withParent != nil {
			_spec.Node.AddColumnOnce(organization2.FieldParentID)
		}
	}
...
func (_q *OrganizationQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(organization2.Table)
	columns := _q.ctx.Fields
	if len(columns) == 0 {
		columns = organization2.Columns
	}
