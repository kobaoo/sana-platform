// Package policy contains pure authorization rule functions for the users domain.
// Functions here have no Encore runtime dependencies and can be tested with plain go test.
package policy
...
func CheckUserAccess(isActive bool) error {
	if !isActive {
