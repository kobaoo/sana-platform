...
func (m *CertificateMutation) ClearEmployee() {
	m.clearedemployee = true
	m.clearedFields[certificate.FieldEmployeeID] = struct{}{}
}

// EmployeeCleared reports if the "employee" edge to the Employee entity was cleared.
func (m *CertificateMutation) EmployeeCleared() bool {
...
func (m *CertificateMutation) EmployeeIDs() (ids []uuid.UUID) {
...
func (m *CertificateMutation) ResetEmployee() {
	m.employee = nil
...
func (m *CertificateMutation) AddedEdges() []string {
	...
	if m.employee != nil {
		edges = append(edges, certificate.EdgeEmployee)
	}
	return edges
}
