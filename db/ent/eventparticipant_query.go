...
func (_q *EventParticipantQuery) QueryEmployee() *EmployeeQuery {
...
func (_q *EventParticipantQuery) QueryReviewer() *UserQuery {
...
func (_q *EventParticipantQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *EventParticipantQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *EventParticipantQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *EventParticipantQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *EventParticipantQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *EventParticipantQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *EventParticipantQuery) WithEmployee(opts ...func(*EmployeeQuery)) *EventParticipantQuery {
	query := (&EmployeeClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EventParticipantQuery) WithReviewer(opts ...func(*UserQuery)) *EventParticipantQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(eventparticipant.FieldEventID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *EventParticipantQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*EventParticipant, error) {
	...
	if query := _q.withEmployee; query != nil {
		if err := _q.loadEmployee(ctx, query, nodes, nil,
			func(n *EventParticipant, e *Employee) { n.Edges.Employee = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withReviewer; query != nil {
		if err := _q.loadReviewer(ctx, query, nodes, nil,
			func(n *EventParticipant, e *User) { n.Edges.Reviewer = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *EventParticipantQuery) loadEvent(ctx context.Context, query *EventQuery, nodes []*EventParticipant, init func(*EventParticipant), assign func(*EventParticipant, *Event)) error {
	...
	nodeids := make(map[uuid.UUID][]*EventParticipant)
	for i := range nodes {
		fk := nodes[i].EventID
...
func (_q *EventParticipantQuery) loadEmployee(ctx context.Context, query *EmployeeQuery, nodes []*EventParticipant, init func(*EventParticipant), assign func(*EventParticipant, *Employee)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*EventParticipant)
	for i := range nodes {
...
func (_q *EventParticipantQuery) loadReviewer(ctx context.Context, query *UserQuery, nodes []*EventParticipant, init func(*EventParticipant), assign func(*EventParticipant, *User)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*EventParticipant)
	for i := range nodes {
...
func (_q *EventParticipantQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(eventparticipant.Table, eventparticipant.Columns, sqlgraph.NewFieldSpec(eventparticipant.FieldID, field.TypeUUID))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withEmployee != nil {
			_spec.Node.AddColumnOnce(eventparticipant.FieldEmployeeID)
		}
		if _q.withReviewer != nil {
			_spec.Node.AddColumnOnce(eventparticipant.FieldReviewedBy)
		}
	}
