...
func (_c *UserCreate) SetKeycloakUserID(v string) *UserCreate {
	_c.mutation.SetKeycloakUserID(v)
	return _c
}
...
func (_c *UserCreate) SetDzoID(v uuid.UUID) *UserCreate {
	_c.mutation.SetDzoID(v)
	return _c
}

// SetNillableDzoID sets the "dzo_id" field if the given value is not nil.
func (_c *UserCreate) SetNillableDzoID(v *uuid.UUID) *UserCreate {
	if v != nil {
		_c.SetDzoID(*v)
	}
	return _c
...
func (_c *UserCreate) SetIsOnboarded(v bool) *UserCreate {
	_c.mutation.SetIsOnboarded(v)
	return _c
}

// SetNillableIsOnboarded sets the "is_onboarded" field if the given value is not nil.
func (_c *UserCreate) SetNillableIsOnboarded(v *bool) *UserCreate {
	if v != nil {
		_c.SetIsOnboarded(*v)
	}
	return _c
...
func (_c *UserCreate) defaults() {
	...
	if _, ok := _c.mutation.IsOnboarded(); !ok {
		v := user.DefaultIsOnboarded
		_c.mutation.SetIsOnboarded(v)
	}
...
func (_c *UserCreate) check() error {
	if _, ok := _c.mutation.KeycloakUserID(); !ok {
		return &ValidationError{Name: "keycloak_user_id", err: errors.New(`ent: missing required field "User.keycloak_user_id"`)}
	}
	if v, ok := _c.mutation.KeycloakUserID(); ok {
	...
	if _, ok := _c.mutation.IsOnboarded(); !ok {
		return &ValidationError{Name: "is_onboarded", err: errors.New(`ent: missing required field "User.is_onboarded"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.KeycloakUserID(); ok {
		_spec.SetField(user.FieldKeycloakUserID, field.TypeString, value)
		_node.KeycloakUserID = value
	}
	...
	if value, ok := _c.mutation.IsOnboarded(); ok {
		_spec.SetField(user.FieldIsOnboarded, field.TypeBool, value)
		_node.IsOnboarded = value
	}
