...
func (_u *CategoryUpdate) AddExternalTrainingEventIDs(ids ...uuid.UUID) *CategoryUpdate {
...
func (_u *CategoryUpdate) AddExternalTrainingEvents(v ...*ExternalTrainingEvent) *CategoryUpdate {
...
func (_u *CategoryUpdate) ClearExternalTrainingEvents() *CategoryUpdate {
...
func (_u *CategoryUpdate) RemoveExternalTrainingEventIDs(ids ...uuid.UUID) *CategoryUpdate {
...
func (_u *CategoryUpdate) RemoveExternalTrainingEvents(v ...*ExternalTrainingEvent) *CategoryUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *CategoryUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.ExternalTrainingEventsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   category.ExternalTrainingEventsTable,
			Columns: []string{category.ExternalTrainingEventsColumn},
			Bidi:    false,
...
// AddExternalTrainingEventIDs adds the "external_training_events" edge to the ExternalTrainingEvent entity by IDs.
func (_u *CategoryUpdateOne) AddExternalTrainingEventIDs(ids ...uuid.UUID) *CategoryUpdateOne {
	_u.mutation.AddExternalTrainingEventIDs(ids...)
	return _u
}

// AddExternalTrainingEvents adds the "external_training_events" edges to the ExternalTrainingEvent entity.
func (_u *CategoryUpdateOne) AddExternalTrainingEvents(v ...*ExternalTrainingEvent) *CategoryUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearExternalTrainingEvents clears all "external_training_events" edges to the ExternalTrainingEvent entity.
func (_u *CategoryUpdateOne) ClearExternalTrainingEvents() *CategoryUpdateOne {
	_u.mutation.ClearExternalTrainingEvents()
	return _u
}

// RemoveExternalTrainingEventIDs removes the "external_training_events" edge to ExternalTrainingEvent entities by IDs.
func (_u *CategoryUpdateOne) RemoveExternalTrainingEventIDs(ids ...uuid.UUID) *CategoryUpdateOne {
	_u.mutation.RemoveExternalTrainingEventIDs(ids...)
	return _u
}

// RemoveExternalTrainingEvents removes "external_training_events" edges to ExternalTrainingEvent entities.
func (_u *CategoryUpdateOne) RemoveExternalTrainingEvents(v ...*ExternalTrainingEvent) *CategoryUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
