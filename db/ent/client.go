...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.ScormCourse, c.ScormProgress, c.TrainingEvent, c.TrainingParticipant, c.User,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		Company, DzoOrganization, Employee, Organization, Request, ScormCourse,
		ScormProgress, TrainingEvent, TrainingParticipant, User []ent.Hook
	}
	inters struct {
		Company, DzoOrganization, Employee, Organization, Request, ScormCourse,
		ScormProgress, TrainingEvent, TrainingParticipant, User []ent.Interceptor
	}
)
