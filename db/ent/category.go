...
func (e CategoryEdges) ExternalTrainingEventsOrErr() ([]*ExternalTrainingEvent, error) {
	if e.loadedTypes[0] {
...
// QueryExternalTrainingEvents queries the "external_training_events" edge of the Category entity.
func (_m *Category) QueryExternalTrainingEvents() *ExternalTrainingEventQuery {
	return NewCategoryClient(_m.config).QueryExternalTrainingEvents(_m)
}
